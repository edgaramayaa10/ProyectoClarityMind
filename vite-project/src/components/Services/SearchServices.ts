...
export const data = [
    ...
    { id: 3, title: 'Perfil de usuario', description: 'Gestiona tu perfil y preferencias en la plataforma.', url: '/perfil' },
    { id: 4, title: 'Cerrar sesión', description: 'Opción para cerrar sesión de tu cuenta de usuario.', url: '/logout' }
];
